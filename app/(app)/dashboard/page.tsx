        ...
        {PERIOD_CARDS.map((p) => {
          ...
          return (
            <button
              ...
              className="tap relative rounded-2xl border border-white/10 bg-[color:var(--surface)]/80 p-5 text-left transition hover:border-[var(--brand-yellow)]/30 hover:bg-[color:var(--surface)]"
